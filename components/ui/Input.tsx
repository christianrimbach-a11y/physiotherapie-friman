...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ id, label, error, required, className = "", ...props }, ref) => {
    const base =
      "w-full px-4 py-3 border border-gray-200 rounded-button bg-white text-gray-800 placeholder-gray-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-900 focus-visible:ring-offset-0 focus:border-gray-900";
